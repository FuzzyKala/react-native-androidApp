...
const Login = ({ navigation }) => {
  const loginBtnPress = (username: string, password: string) => {
    console.log("Login button pressed!");

    if (username.length == 0 || password.length == 0) {
      Alert.alert("Error: Please enter username and password!");
      console.log("Login fail. Please enter username and password.");
    }
  };
      ...
      <View style={asm2Styles.wrapper}>
        ...
        <BlurView intensity={40} tint="light" style={asm2Styles.body}>
          <View style={asm2Styles.innerHeader}>
            <Text style={asm2Styles.text}>Login</Text>
          </View>
          <View style={asm2Styles.innerBody}>
            ...
            <View style={asm2Styles.loginBtn}>
              <Pressable onPress={() => loginBtnPress(username, password)}>
                <Text style={asm2Styles.loginText}>Login</Text>
              </Pressable>
            </View>
          ...
          <View style={asm2Styles.innerFooter}>
            <Text style={asm2Styles.innerFooterText}>New here? </Text>
            <Pressable
              onPress={() => {
                navigation.navigate("Register");
              }}
            >
              <Text style={asm2Styles.registerText}>Sign up now!</Text>
            </Pressable>
          </View>
        </BlurView>
